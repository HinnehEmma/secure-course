    ...
    <>
      {!loading && !currentUser ? (
        ...
        <div className="flex min-h-screen w-full flex-col bg-muted/40">
          <aside className="fixed inset-y-0 left-0 z-10 hidden w-[220px] lg:w-[18rem] flex-col border-r border-r-black bg-background sm:flex">
            <nav className="flex flex-col gap-4">
              <div className="flex items-center gap-2 border-b border-b-black p-3 h-14">
                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        ...
                        {
                          "border-l-[5px] border-l-black bg-primary p-2 rounded-r-md text-white":
          ...
          <div className="flex flex-col sm:gap-4 sm:pl-[220px] lg:pl-[18rem]">
            <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b border-b-black bg-background px-4">
